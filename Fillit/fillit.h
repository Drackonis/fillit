...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/12/19 16:03:49 by rkergast          #+#    #+#             */
/*   Updated: 2018/12/19 16:07:27 by rkergast         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_carre				*fill_it(t_carre *carre, t_piece *first, t_piece\
	*start, int nbpiece);
...
void				place_piece(t_piece *piece, t_carre\
	*carre, t_pos *pos, int c);
